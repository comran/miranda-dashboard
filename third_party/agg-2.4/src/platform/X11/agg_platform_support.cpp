...
bool platform_support::init(unsigned width, unsigned height, unsigned flags) {
  ...
  //                                     &vi))
  //                 {
  // //                     printf("TrueColor  depth=%d, red=%08x, green=%08x,
  // blue=%08x, bits=%d\n",
  // //                         vi.depth,
  // //                         vi.visual->red_mask,
  ...
  //                                     &vi))
  //                 {
  // //                     printf("DirectColor depth=%d, red=%08x, green=%08x,
  // blue=%08x, bits=%d\n",
  // //                         vi.depth,
  // //                         vi.visual->red_mask,
  // //                         vi.visual->green_mask,
  ...
  memset(&m_specific->m_window_attributes, 0,
  ...
  m_specific->m_gc =
      XCreateGC(m_specific->m_display, m_specific->m_window, 0, 0);
      ...
      case ConfigureNotify: {
        if (x_event.xconfigure.width != int(m_rbuf_window.width()) ||
          ...
          m_rbuf_window.attach(
              m_specific->m_buf_window, width, height,
              m_flip_y ? -width * (m_bpp / 8) : width * (m_bpp / 8));
...
bool platform_support::create_img(unsigned idx, unsigned width,
  ...
  if (idx < max_images) {
    ...
    m_rbuf_img[idx].attach(
        m_specific->m_buf_img[idx], width, height,
        m_flip_y ? -width * (m_bpp / 8) : width * (m_bpp / 8));
    return true;
  }
  return false;
...
//------------------------------------------------------------------------
void platform_support::force_redraw() { m_specific->m_update_flag = true; }
...
//------------------------------------------------------------------------
void platform_support::start_timer() { m_specific->m_sw_start = clock(); }
